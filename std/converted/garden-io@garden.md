...
2. The next step depends on the release type:
    ...
    * If youve already created a pre-release, e.g. `v1.2.3-alpha.0`, and want to create a new pre-release `v1.2.3-alpha.1` which includes fixes merged to master since `v1.2.3-alpha.0` was created, do the following:
    ...
    * If youre ready to make a proper release, do the following:
