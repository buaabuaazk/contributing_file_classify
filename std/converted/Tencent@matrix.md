# Contributing to Wechat-Matrix

Welcome to [report Issues](https://github.com/Tencent/matrix/issues) or [pull requests](https://github.com/Tencent/matrix/pulls). It's recommended to read the following Contributing Guide first before contributing. 
...
We strongly welcome your pull request to make Wechat-Matrix better. 
...
Use [Code Style](https://github.com/Tencent/matrix/blob/master/checkstyle.xml) for Java and Android.

* 4 spaces for indentation rather than tabs

## License

By contributing to Wechat-Matrix, you agree that your contributions will be licensed

under its [BSD LICENSE](https://github.com/Tencent/matrix/blob/master/LICENSE)