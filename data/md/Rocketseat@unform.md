...
By default, Travis CI automatically runs the building process whenever you push changes. If your commit is about documentation or meta files, you can override this behavior by adding a **[skip ci]** tag anywhere in a commits **footer**. This not only skips the marked commit, but also **all other commits** in the push.
...
- If youve fixed a bug or added code that should be tested, **add tests**;
