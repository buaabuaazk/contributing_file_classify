...
9. Create a pull request (PR) against our **dev** branch.
    ...
    ? It is OK for your PR to include a large number of commits. We will squash them on merge.

    ? It is also OK to create your PR as "[WIP]" before the implementation is done. This can be useful if you'd like to start the feedback process while you finish your implementation. State that this is the case in the initial PR comment.